...
# Form implementation generated from reading ui file 'NameModeWindow.ui'
#
...
with open('Periodic Table of Elements.csv', mode='r+') as f:
    ...
    class Ui_NameModeWindow(object):
        def setupUi(self, NameModeWindow):
            NameModeWindow.setObjectName("NameModeWindow")
            ...
            self.input_element_name.setPlainText("Example : Hydrogen or hydrogen")
            ...
            NameModeWindow.setCentralWidget(self.centralwidget)

            self.retranslateUi(NameModeWindow)
            QtCore.QMetaObject.connectSlotsByName(NameModeWindow)

        def retranslateUi(self, NameModeWindow):
            _translate = QtCore.QCoreApplication.translate
            NameModeWindow.setWindowTitle(_translate("NameModeWindow", "Elementium"))
            self.summit_button.setText(_translate("NameModeWindow", "SUMMIT"))
        ...
        def StartGame(self):
            ...
            if hp > 0 :
                ...
                self.Element_name.setText(_translate("NameModeWindow", f"<html><head/><body><p align=\"center\"><span style=\" font-size:12pt; font-weight:600;\">{random_element[0]}</span></p></body></html>"))
            else:
                self.Element_name.setText(_translate("NameModeWindow", f"<html><head/><body><p align=\"center\"><span style=\" font-size:12pt; font-weight:600;\">Game Over</span></p></body></html>"))
            print(random_element)

        def CheckAnswer(self):
            global hp, score, random_element 
            answer = self.input_element_name.toPlainText()
            if answer.lower() == random_element[1].lower():
                score += 1
...
import NameModeWindowImages_rc

if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    NameModeWindow = QtWidgets.QMainWindow()
    ui = Ui_NameModeWindow()
    ui.setupUi(NameModeWindow)
    NameModeWindow.show()
    sys.exit(app.exec_())
